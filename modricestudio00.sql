...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-12-2025 a las 03:18:32
...
(9, 64, 'Combo basico', 'Usuario: nombreejemplo937\nContraseña: temp1210', '2025-12-16 19:27:53', '2026-01-01 01:27:00', 'Activo');
...
(35, 9, 8, '2025-12-06', 'Finalizado', '2025-12-06 20:50:00'),
(36, 5, 8, '2025-12-06', 'Finalizado', '2025-12-06 20:50:22'),
(38, 9, 8, '2025-12-11', 'Finalizado', '2025-12-11 22:40:50'),
(39, 21, 8, '2025-12-11', 'Finalizado', '2025-12-11 22:41:00'),
(40, 21, 5, '2025-12-12', 'Activo', '2025-12-12 02:20:37'),
(41, 19, 5, '2025-12-12', 'Activo', '2025-12-12 02:20:45'),
(42, 21, 20, '2025-12-13', 'Activo', '2025-12-13 00:16:03'),
(43, 62, 20, '2025-12-13', 'Activo', '2025-12-13 00:16:10'),
(46, 19, 23, '2025-12-17', 'Activo', '2025-12-16 20:16:31'),
(47, 62, 20, '2025-12-16', 'Activo', '2025-12-16 20:25:11');
...
(5, 'UTP', 'Sede central', '64334531', '2025-11-30 19:48:35', 'Activo', 'Solo se atenderan los de tercer año'),
(8, 'Instituto Nacional', 'Av. Balboa, Ciudad de Panamá', '6000-1111', '2025-12-05 19:50:18', 'Cerrado', NULL),
(20, 'Lugar 1', 'Calle 1', '6557-0987', '2025-12-12 21:24:58', 'Activo', 'lugar de ejemplo'),
(23, 'Lugar 2', 'calle 2', '6574-4565', '2025-12-16 20:14:59', 'Activo', 'lugar de ejemplo 2, \nse atenderá el 17 de dic');
...
CREATE TABLE `factura` (
  ...
  `RutaFacturacion` varchar(255) DEFAULT NULL,
  `Fecha` datetime NOT NULL DEFAULT current_timestamp(),
  `MedioEnvio` varchar(20) DEFAULT NULL,
  `ID_Pedido` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(23, 9, 'descarga (1).jpeg', '../uploads/clientes/64/album_9/foto_6941f92e502986.51275303.jpeg', 70631, '2025-12-16 19:28:30', 1, '2025-12-16 21:14:19');
...
(1, 10, 167.00, 'Yappy', 'Abono inicial registrado por el vendedor', '2025-12-12 02:23:30', 19),
(2, 11, 90.00, 'Yappy', 'Abono inicial registrado por el vendedor', '2025-12-12 02:25:30', 19),
(4, 12, 120.00, 'Efectivo', '', '2025-12-12 23:34:58', 1),
(5, 12, 130.00, 'Yappy', '', '2025-12-12 23:36:06', 1),
(6, 14, 400.00, 'Transferencia', 'Abono inicial registrado por el vendedor (migración automática)', '2025-12-12 23:51:12', 19),
(7, 15, 40.00, 'Yappy', 'Abono inicial registrado por el vendedor (migración automática)', '2025-12-12 23:56:21', 19),
(9, 15, 25.30, 'Yappy', '', '2025-12-13 00:15:08', 1),
(10, 16, 270.00, 'Transferencia', 'Abono inicial registrado por el vendedor', '2025-12-13 00:18:58', 62),
(11, 17, 200.00, 'Yappy', 'Abono inicial registrado por el vendedor', '2025-12-13 00:19:50', 62),
(12, 18, 130.00, 'Yappy', 'Abono inicial registrado por el vendedor', '2025-12-13 00:22:37', 62),
(13, 18, 10.00, 'Yappy', '', '2025-12-13 00:26:34', 1),
(14, 18, 10.00, 'Yappy', '', '2025-12-13 00:27:28', 1),
(15, 14, 200.00, 'Yappy', '', '2025-12-13 00:31:55', 1),
(16, 19, 100.00, 'Efectivo', 'Abono inicial registrado por el vendedor', '2025-12-13 00:42:21', 62),
(17, 15, 84.70, 'Yappy', '', '2025-12-13 00:49:07', 1),
(18, 16, 50.00, 'Efectivo', '', '2025-12-13 01:49:33', 1),
(19, 19, 25.00, 'Transferencia', 'nose', '2025-12-13 12:41:24', 1),
(20, 19, 25.00, 'Yappy', '', '2025-12-13 12:41:54', 1),
(21, 17, 40.00, 'Yappy', '', '2025-12-13 13:49:18', 1),
(22, 17, 40.00, 'Yappy', '', '2025-12-13 13:49:47', 1),
(23, 16, 35.00, 'Yappy', '', '2025-12-13 16:07:18', 1),
(24, 16, 25.00, 'Yappy', '', '2025-12-13 16:08:07', 1),
(25, 20, 60.00, 'Yappy', 'Abono inicial registrado por el vendedor', '2025-12-16 21:12:33', 62);
...
(1, 23, 64, '2025-12-16 21:14:19', '127.0.0.1');
...
(12, '2025-12-12 19:20:10', 'Completado', 2, NULL, NULL, 21, 'Tamarindo Limares', 21, 3, NULL, 5, 250.00),
(13, '2025-12-12 19:23:09', 'Completado', 2, NULL, NULL, 21, 'Mango Malar', 21, NULL, 5, 5, 200.00),
(14, '2025-12-12 23:51:12', 'Completado', 1, NULL, NULL, 19, 'cebolla morada', 19, 5, NULL, 5, 600.00),
(15, '2025-12-12 23:56:21', 'Completado', 2, NULL, NULL, 19, 'random 1', 19, 4, NULL, 5, 150.00),
(16, '2025-12-13 00:18:58', 'Completado', 1, NULL, NULL, 62, 'Mariana Lima', 62, NULL, 4, 20, 380.00),
(17, '2025-12-13 00:19:50', 'Completado', 2, NULL, NULL, 62, 'random 2', 62, NULL, 3, 20, 280.00),
(18, '2025-12-13 00:22:37', 'Completado', 2, NULL, NULL, 62, 'Michelle Delfin', 62, 4, NULL, 20, 150.00),
(19, '2025-12-13 00:42:21', 'Completado', 2, NULL, NULL, 62, 'random 3', 62, 4, NULL, 20, 150.00),
(20, '2025-12-16 21:12:33', 'Pendiente', 2, NULL, NULL, 62, 'cliente ejemplo 1', 62, 4, NULL, 20, 150.00),
(21, '2025-12-16 21:13:00', 'Pendiente', 1, NULL, NULL, 62, 'cliente ejemplo 2', 62, NULL, 4, 20, 380.00);
...
(2, 'Luis Vendedor', 'vendedor@modric.com', 'Luisvend', 'password123', 'Vendedor', NULL, NULL, NULL, NULL, NULL, 0),
...
(9, 'Delfin Morado', 'delfinmorado@modric.com', 'dvendedor', 'password123', 'Vendedor', NULL, 'Grupo E.Pedro', 'Pedro Pablo Sanchez', NULL, NULL, 0),
...
(62, 'Pan vendedor', 'pan123@modric.com', 'panquevende', 'password123', 'Vendedor', NULL, NULL, NULL, NULL, NULL, 0),
(64, 'nombre ejemplo', 'nombre123@modric.com', 'nombreejemplo937', 'password123', 'Cliente', NULL, NULL, NULL, 'temp1210', '2025-12-16 19:26:59', 1),
(67, 'laia', 'laia123@gmail.com', 'laia vendedora', 'password123', 'Vendedor', NULL, NULL, NULL, NULL, NULL, 0);
...
(7, 10, 'oldarei', 'Yappy', 'Abono', 167.00, 'La sesion sera en el salon de conferencias de la sede principal\n\nMotivo cancelación: porquesi y weno', '2025-12-12 02:23:31'),
(8, 11, 'jigmaei', 'Yappy', 'Abono', 90.00, 'La sesion será en el salon D1 edificio 3\n\nMotivo cancelación: No canceló', '2025-12-12 02:25:30'),
(9, 12, 'Tamarindo Limares', 'Efectivo', 'Completo', 250.00, 'Pidio que la sesion se haga en plaza italia', '2025-12-12 19:20:10'),
(10, 13, 'Mango Malar', 'Yappy', 'Completo', NULL, 'Sera en el museo nacional.', '2025-12-12 19:23:09'),
(11, 14, 'cebolla morada', 'Transferencia', 'Completo', 600.00, 'El evento se realizará en el convention center :0', '2025-12-12 23:51:12'),
(12, 15, 'random 1', 'Yappy', 'Completo', 150.00, 'La sesión será en la casa de su abuela.', '2025-12-12 23:56:21'),
(13, 16, 'Mariana Lima', 'Transferencia', 'Completo', 380.00, 'Quiere una reunion para buscar un lugar para la sesion', '2025-12-13 00:18:58'),
(14, 17, 'random 2', 'Yappy', 'Completo', 280.00, 'Sera en nose', '2025-12-13 00:19:50'),
(15, 18, 'Michelle Delfin', 'Yappy', 'Completo', 150.00, 'quiere una reunion en un lugar ', '2025-12-13 00:22:37'),
(16, 19, 'random 3', 'Efectivo', 'Completo', 150.00, 'texto texto texto', '2025-12-13 00:42:21'),
(17, 20, 'cliente ejemplo 1', 'Yappy', 'Abono', 60.00, 'La sesion sera en un lugar ', '2025-12-16 21:12:33'),
(18, 21, 'cliente ejemplo 2', 'Transferencia', 'Completo', NULL, '', '2025-12-16 21:13:00');
...
--
ALTER TABLE `asignacionvendedor`
  MODIFY `ID_Asignacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `colegio`
  MODIFY `ID_Colegio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `historialabonos`
  MODIFY `ID_Abono` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `ventainfo`
  MODIFY `ID_VentaInfo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
