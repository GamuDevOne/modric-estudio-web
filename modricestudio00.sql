...
ALTER TABLE `factura`
  ADD COLUMN `RutaFacturacion` VARCHAR(255) NULL AFTER `NumeroOrden`;

ALTER TABLE `factura`
  MODIFY COLUMN `MedioEnvio` VARCHAR(20) DEFAULT NULL;

ALTER TABLE `factura`
  MODIFY COLUMN `ID_Pedido` INT(11) DEFAULT NULL;
